...
// Plasmic Project: 4UossaBBDsALFbQ5y66TxD
// Component: BPr44wxEkaF
...
import projectcss from "./plasmic_app_starter.module.css"; // plasmic-import: 4UossaBBDsALFbQ5y66TxD/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: BPr44wxEkaF/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: f9HSP1jSmkc/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: x5eOFOLF60A/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__zYkG)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__tsdwm)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__rGboR)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__cIwuF)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__lDeI8)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
